...
public class Location {
	 ...
	 */
	public void setLocationDeduced_city_deduced(String locationDeduced_city_deduced) {
	 ...
	 */
	public void setLocationDeduced_country_code(String locationDeduced_country_code) {
	 ...
	 */
	public void setLocationDeduced_country_name(String locationDeduced_country_name) {
	 ...
	 */
	public void setLocationDeduced_county_code(String locationDeduced_county_code) {
	 ...
	 */
	public void setLocationDeduced_county_name(String locationDeduced_county_name) {
	...
	/**
	 * Method to build the location map, this combines all the existing location fields into one.
	 * @return
	 */
